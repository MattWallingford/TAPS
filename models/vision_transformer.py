...
from timm.models.layers.mlp import Mlp_Freeze
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.mlp = Mlp_Freeze(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
...
class VisionTransformer(nn.Module):
    ...
    def getIndicators(model):
        """Return list of importance scores for each layer"""
        indicators = []
